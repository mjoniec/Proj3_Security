...
{
    /// <summary>
    /// changed to static after copying from this tutorial https://medium.com/@evandro.ggomes/json-web-token-authentication-with-asp-net-core-2-0-b074b0cfc870
    /// original comments:
    ...
    public static class PasswordHasher
    {
        ...
        public static bool PasswordMatches(string providedPassword, string passwordHash)
        {
            byte[] buffer4;
